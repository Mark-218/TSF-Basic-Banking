...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Mark's Bank</a>
  ...
  <div class="backimg">
    <img src="images/back.jpg" class="img-fluid" alt="Mark's Bank">
  </div>
...
<div class="container">
  <div class="row">
    <div class="col">
    <div class="card border-success  mx-4 my-1 " style="max-width: 19rem;">
 ...
 <form method="post" >
  ...
  <option selected > Debtors users </option>
    <option value="Mayur Patil">Mayur patil</option>
  ...
  <div class="mb-3">
    <label for="user2" class="form-label">Select User</label>
...
if (isset($_POST['submit'])) {
 ...
 if ($result){
     ...
     echo " <br/> <br/> Transaction complete :) ";
